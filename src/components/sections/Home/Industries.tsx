...
const industries = [
  ...
  },
  {
    ...
    image: "/images/industries/health.webp",
    icon: HeartPulse,
  ...
  },
  {
    ...
    image: "/images/industries/public.webp",
    icon: ShieldCheck,
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      if (panelsRef.current) {
        gsap.from(
          panelsRef.current.querySelectorAll<HTMLElement>("[data-panel]"),
          {
            opacity: 0,
            y: 60,
            scale: 0.92,
      ...
      if (mobilePanelsRef.current) {
        gsap.from(
          mobilePanelsRef.current.querySelectorAll<HTMLElement>(
            "[data-mobile-card]",
          ),
          {
            opacity: 0,
