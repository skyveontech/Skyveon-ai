...
export default function AboutPage() {
  ...
  return (
    <div ref={rootRef} className="text-[#1a1a1a] bg-white overflow-x-hidden">
      {/* ══ HERO ══ */}
      <section className="hero-section relative  flex items-center py-8 md:py-20 overflow-hidden">
        {/* Background */}
      ...
      {/* ══ WHO WE ARE ══ */}
      <section className="py-12 md:py-20 px-5 md:px-10 max-w-[1200px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          {/* Left copy */}
          <div className="fade-up order-2 lg:order-1">
            <p className="text-[12px] md:text-[13px] font-bold tracking-[0.1em] text-orange-500 uppercase mb-3">
              | Who We Are
            </p>

            <h2 className="text-3xl md:text-5xl lg:text-[52px] font-semibold leading-[1.1] tracking-[-0.03em] mb-6">
              Builders at <span className="text-orange-500">Heart</span>
            </h2>

            <p className="text-[15px] md:text-[17px] leading-[1.8] text-[#555] mb-5">
            ...
            <p className="text-[15px] md:text-[17px] leading-[1.8] text-[#555]">
          ...
          <div className="fade-up relative order-1 lg:order-2">
            <img
              src={teamImg}
              alt="Our team"
              className="w-full rounded-2xl object-cover aspect-[4/3] block shadow-lg"
            />

            {/* Floating Stats Card */}
            <div className="absolute bottom-4 left-4 md:-bottom-5 md:-left-5 bg-orange-500 text-white rounded-xl px-5 py-4 md:px-6 md:py-5 shadow-xl">
              <p className="text-2xl md:text-[32px] font-bold leading-none">
                50+
              </p>

              <p className="mt-1 text-[10px] md:text-[12px] font-semibold tracking-[0.06em] uppercase">
                Projects Delivered
              </p>
            </div>
          </div>
      ...
      <section className="bg-[#FFF4EE] py-8 md:py-12 px-10">
        <div className="mission-quote max-w-[860px] mx-auto text-center">
          <Quote
            size={48}
            color="#E85A00"
            className="opacity-25 mb-6 mx-auto"
          />
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/76 flex flex-col items-center justify-center gap-7">
          ...
          <Link
            to="/contact"
            className="fade-up inline-block bg-orange-500 text-white border-none rounded-md px-8 py-3.5 text-[15px] font-bold tracking-[0.04em] transition-colors hover:bg-[#cc4f00]">
            Reach Us
          </Link>
        </div>
      </section>
            ...
            {principles.map((v) => {
              ...
              return (
                <div
                  ...
                  <h3 className="m-0 mb-2.5 text-[20px] font-extrabold">
                    {v.title}
                  </h3>
      ...
      {/* ══ PROCESS ══ */}
      <section className="bg-[#0f0f0f] py-12 md:py-20 px-5 md:px-10">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="stagger-parent grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 lg:gap-[2px]">
            {process.map((step, i) => (
              <div
                key={step.number}
                className={`stagger-child rounded-xl lg:rounded-none p-6 md:p-8 ${
                  i % 2 === 0 ? "bg-[#1a1a1a]" : "bg-[#151515]"
                }`}>
                <p className="mb-4 text-4xl md:text-5xl font-bold text-orange-500/30 leading-none">
                  {step.number}
                </p>
                ...
                <p className="text-sm md:text-[15px] leading-7 text-[#888]">
                  {step.description}
                </p>
              </div>
            ))}
      ...
      {/* ══ STATS ══ */}
      <section className="bg-orange-500 py-12 md:py-20 px-5 md:px-10">
        <div className="max-w-[1200px] mx-auto grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-5 text-center">
          {stats.map((s) => (
            <div key={s.label}>
              <p
                className="stat-val counter text-4xl md:text-6xl font-bold text-white leading-none"
              ...
              <p className="mt-2 text-xs md:text-sm text-white/80 tracking-[0.05em] uppercase font-semibold">
                {s.label}
              </p>
            </div>
          ))}
   ...
   {/* ══ CULTURE ══ */}
<section className="px-5 md:px-10 pb-16 md:pb-24 lg:pb-[100px] max-w-[1200px] mx-auto">
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-[60px] items-center">
    ...
    <div className="fade-up order-2 lg:order-1">
      ...
      <p className="text-[15px] md:text-[17px] leading-[1.8] text-[#555] mb-8">
        ...
        we serve. We empower our teams to innovate, challenge assumptions,
        and continuously grow while delivering exceptional outcomes.
      </p>

      <Link
        to="/career"
        className="inline-flex items-center gap-2 rounded-xl bg-orange-500 px-7 py-3.5 text-[15px] font-bold text-white transition-all duration-300 hover:bg-orange-600 hover:-translate-y-1 hover:shadow-lg"
      >
        Join Our Team
      </Link>
    </div>
      ...
      <section className="bg-[#0f0f0f] py-20 px-10 text-center">
        ...
        <Link
          to="/contact"
          className="fade-up inline-flex items-center gap-2 rounded-md bg-orange-500 px-9 py-4 text-[16px] font-bold text-white transition-colors hover:bg-[#cc4f00]">
          Let's Talk
          <ArrowRight size={17} />
        </Link>
      </section>
